...
echo "    By : Rico\n";
echo "=======================\n";
echo "1. Login x Claim (Akun Lama)\n";
echo "2. Register Doang (Nomer Baru)\n";
echo "=======================\n";
echo "Select Your Tools: ";
	// Mulai
$type = trim(fgets(STDIN));
if($type == 2){
echo "Mulai Melakukan Register\n";
...
if ($login == false)
	...
	if ($verif == false)
		...
		{
		echo "Mulai Claim Code\n";
		$claim = claim($verif);
		if ($claim == false)
			{
			echo "Failed to Claim Voucher, Try to Claim Manually Code : GOFOODNASGOR07 / GOFOODSATE15\n";
			}
		  else
			{
			echo $claim . "\n";
